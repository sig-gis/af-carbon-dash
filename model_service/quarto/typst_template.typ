...
[
  #align(center)[
  #text(weight: "bold", size: 11pt, fill: brand-color.primary)[Figure 2. Cumulative onsite Carbon per acre (tons CO₂ per acre).]
]
]),
...
[
  #align(center)[
  #text(weight: "bold", size: 11pt, fill: brand-color.primary)[Figure 3. Cumulative onsite Carbon for the full project area (tons CO₂).]
]
]),
kind: "quarto-float-fig",
supplement: "Figure",
...
[
  #align(center)[
  #text(weight: "bold", size: 11pt, fill: brand-color.primary)[Figure 6. Net revenue trends by protocol for the selected planting scenario across the duration of the project.]
]
]),
kind: "quarto-float-fig",
supplement: "Figure",
...
The same project scenario can yield different credit numbers across protocols because of differences in accounting rules #footnote[To isolate protocol-rule effects, the dashboard uses Jenkins biomass equations for all protocols (we do not switch between Jenkins and FVS Fire and Fuels module).].
...
#table(
  ...
  [#link("https://verra.org/methodologies/vm0047-afforestation-reforestation-and-revegetation-v1-0/")[Verra (VCS)]], [20%], [0%], [0%], [Jenkins #footnote[#link("https://academic.oup.com/forestscience/article-abstract/49/1/12/4617214")[Jenkins, J. C., Chojnacky, D. C., Heath, L. S., & Birdsey, R. A. (2003). National-scale biomass estimators for United States tree species. Forest Science, 49(1), 12–35.]]],
  [#link("https://acrcarbon.org/methodology/afforestation-and-reforestation-of-degraded-lands/")[ACR]], [20%], [0%], [0%], [Jenkins],
  [#link("https://www.climateactionreserve.org/wp-content/uploads/2023/07/Final_Forest_Protocol_V5.1_7.14.2023.pdf")[CAR]], [20%], [0%], [0%], [Jenkins],
  [#link("https://registry.isometric.com/protocol/reforestation/1.0")[Isometric]], [25%], [0%], [0%], [Jenkins],
  [#link("https://globalgoals.goldstandard.org/403-luf-ar-methodology-ghgs-emission-reduction-and-sequestration-methodology/")[Gold Standard]], [0%], [0%], [0%], [Jenkins],
)
...
Yes.
The dashboard would have warned you if the total TPA exceeds a cap, but extreme inputs can still produce unrealistic scenarios.
]
